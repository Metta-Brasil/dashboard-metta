  ...
  return (
    <div className="flex w-full max-w-3xl flex-col gap-6">
      <div className="surface-card grid overflow-hidden p-0 md:grid-cols-2">
        ...
        {/* Direita — painel visual Metta (azul noite + símbolo) */}
        <div className="relative hidden bg-foreground md:block">
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-6">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/brand/metta-symbol.svg"
              alt=""
              className="size-24 opacity-95"
            />
