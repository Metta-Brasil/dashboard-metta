...
export default function LoginPage() {
  return (
    <div className="surface-card flex w-full max-w-sm flex-col items-center gap-6 p-8">
      <div className="flex flex-col items-center gap-3">
        <span className="flex size-12 items-center justify-center rounded-xl bg-foreground">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/brand/metta-symbol.svg" alt="Metta" className="size-7" />
        </span>
      ...
      <p className="text-center text-sm text-muted-foreground">
        Acesso restrito a contas <strong>@mettabrasil.com.br</strong>.
      </p>
